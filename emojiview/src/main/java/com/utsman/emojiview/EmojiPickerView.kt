...
import com.utsman.emojiview.EmojiPickerConstants.DEFAULT_MAX_RECENT_ITEM_ROWS
...
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
     ...
     *
     * @attr ref com.utsman.emojiview.R.styleable.EmojiPickerView_emojiGridRows
     */
     ...
     *
     * @attr ref com.utsman.emojiview.R.styleable.EmojiPickerView_emojiGridColumns
     */
    ...
    var emptyPlaceholderRes: Int = R.layout.empty_category_text_view
    var categoryPlaceholderRes: Int = R.layout.category_text_view
    ...
    private fun createEmojiPickerBodyAdapter(): EmojiPickerBodyAdapter {
        return EmojiPickerBodyAdapter(
            ...
            emptyPlaceholderRes = emptyPlaceholderRes,
            categoryPlaceholderRes = categoryPlaceholderRes
        )
    }
    ...
    private fun showEmojiPickerView() {
        ...
        with(inflate(context, R.layout.emoji_picker, this)) {
            ...
            ViewCompat.requireViewById<RecyclerView>(this, R.id.emoji_picker_header).apply {
                layoutManager = LinearLayoutManager(context, HORIZONTAL, /* reverseLayout= */ false)
